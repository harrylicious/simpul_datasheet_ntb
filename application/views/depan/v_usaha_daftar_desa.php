  ...
  <div class="col-md-12">
    <div class="card ">
      <div class="card-header ">
        <h5 class="card-title"> DAFTAR SEMUA DESA TERDAFTAR </h5>
      </div>
      <div class="card-body ">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><a href="<?= base_url('usaha/get_data_berd_desa_terdaftar/') . $row->desa; ?>" class="btn btn-danger">Lihat Daftar</a></td>
                </tr>
