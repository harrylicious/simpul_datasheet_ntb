  ...
  <div class="row mb-4">
    <div class="col-md-12">
      <div class="card ">
        ...
        Total Kapasitas:  <strong><a href="#"><?= number_format($data_rangkuman_produksi['total']); ?></a></strong> untuk Komoditas <strong><?= urldecode($ket_komoditas); ?></strong> di <strong>Provinsi Nusa Tenggara Barat </strong> <br> <a href="<?= base_url('komoditas/get_perkomoditas_perkabupaten/'.$ket_komoditas); ?>" class="btn btn-danger">Lihat Daftar Sebaran</a> <br>
